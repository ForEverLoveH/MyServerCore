...
namespace MyServerCode.Summer.Service;

public class TcpSession : IDisposable
{
      public TcpSession(TcpService service)
      {
          Id = Guid.NewGuid();
          Service = service;
          OptionReceiveBufferSize = service.OptionReceiveBufferSize;
          OptionSendBufferSize = service.OptionSendBufferSize;
      }
      /// <summary>
      ///  
      /// </summary>
      ...
      internal void Connect(Socket socket)
      {
          ...
          IsSocketDisposed = false;
            // Setup buffers
          _receiveBuffer = new MyBuffer();
          _sendBufferMain = new MyBuffer();
          _sendBufferFlush = new MyBuffer();
          // Setup event args
          ...
          if (Service.OptionKeepAlive)
              Socket.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.KeepAlive, true);
          if (Service.OptionTcpKeepAliveTime >= 0)
              Socket.SetSocketOption(SocketOptionLevel.Tcp, SocketOptionName.TcpKeepAliveTime, Service.OptionTcpKeepAliveTime);
          if (Service.OptionTcpKeepAliveInterval >= 0)
              Socket.SetSocketOption(SocketOptionLevel.Tcp, SocketOptionName.TcpKeepAliveInterval, Service.OptionTcpKeepAliveInterval);
          if (Service.OptionTcpKeepAliveRetryCount >= 0)
              Socket.SetSocketOption(SocketOptionLevel.Tcp, SocketOptionName.TcpKeepAliveRetryCount, Service.OptionTcpKeepAliveRetryCount);
          // Apply the option: no delay
          if (Service.OptionNoDelay)
          ...
          Service.OnConnectingInternal(this);
          ...
          Service.OnConnectedInternal(this);
          // Call the empty send buffer handler
          if (_sendBufferMain.IsEmpty) OnEmpty();
      }
      /// <summary>
      ///  
      /// </summary>
      ...
      public virtual bool Disconnect()
      {
          ...
          Service.OnDisconnectingInternal(this);
          ...
          Service.OnDisconnectedInternal(this);
      ...
      /// 
      /// </summary>
      private MyBuffer _receiveBuffer;
      /// <summary>
      /// 
      /// </summary>
      ...
      private MyBuffer _sendBufferMain;
      private MyBuffer _sendBufferFlush;
      ...
      public virtual long Send(ReadOnlySpan<byte> buffer)
      {
          ...
          if (sent > 0)
          {
              // Update statistic
              BytesSent += sent;
              Interlocked.Add(ref Service._bytesSent, sent);
      ...
      public virtual long Receive(byte[] buffer, long offset, long size)
      {
          ...
          if (received > 0)
          {
              ...
              Interlocked.Add(ref Service._bytesReceived, received);
      ...
      private bool ProcessReceive(SocketAsyncEventArgs e)
      {
          ...
          if (size > 0)
          {
              // Update statistic
              BytesReceived += size;
              Interlocked.Add(ref Service._bytesReceived, size);
      ...
      private bool ProcessSend(SocketAsyncEventArgs e)
      {
          ...
          if (size > 0)
          {
              ...
              BytesSending -= size;
              BytesSent += size;
              Interlocked.Add(ref Service._bytesSent, size);
