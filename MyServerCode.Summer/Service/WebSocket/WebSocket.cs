...
namespace MyServerCode.Summer.Service.WebSocket;
 ...
 public class WebSocket : IWebSocket
{
    ...
    /// </summary>
    internal readonly MyBuffer WsReceiveFrameBuffer = new MyBuffer();
    /// <summary>
    /// Receive final buffer
    /// </summary>
    internal readonly MyBuffer WsReceiveFinalBuffer = new MyBuffer();
    /// <summary>
    /// Receive mask
    /// </summary>
    ...
    /// Send buffer
    /// </summary>
    internal readonly MyBuffer WsSendBuffer = new MyBuffer();
    /// <summary>
    /// Send mask
    /// </summary>
