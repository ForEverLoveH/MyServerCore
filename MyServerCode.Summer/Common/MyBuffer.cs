...
namespace MyServerCode.Summer.Common;
...
public class MyBuffer
 {
     ...
     /// </summary>
     public MyBuffer() { _data = new byte[0]; _size = 0; _offset = 0; }
     /// <summary>
     /// Initialize a new expandable buffer with the given capacity
     /// </summary>
     public MyBuffer(long capacity) { _data = new byte[capacity]; _size = 0; _offset = 0; }
     /// <summary>
     /// Initialize a new expandable buffer with the given data
     /// </summary>
     public MyBuffer(byte[] data) { _data = data; _size = data.Length; _offset = 0; }
     ...
     /// <param name="buffer">Buffer to append</param>
     /// <returns>Count of append bytes</returns>
     public long Append(MyBuffer buffer) => Append(buffer.AsSpan());
