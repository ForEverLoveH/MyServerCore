...
namespace MyServerCore.Server.RSA
{
    public class RSAService
    {
        ...
        static RSAService()
        {
            RSAKey(out string xmlKey, out string pKey);
            if (!string.IsNullOrEmpty(xmlKey) && !string.IsNullOrEmpty(pKey))
            {
                publicKey = xmlKey;
                privateKey = pKey;
            }
        ...
        private static void RSAKey(out string xmlKeys, out string xmlPublicKey)
        {
            try
            {
